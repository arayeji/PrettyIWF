...
**Host:** THR1EPC01 `10.234.241.10`  
**STP:** `10.234.241.21:2905` (dynamic ASP e.g. `asp-dyn-*`)  
...
- [ ] `ip = 10.234.241.21` (not `127.0.0.1` sample from repo).
- [ ] `local_ip = 10.234.241.10` if STP ACLs on source.
...
| P3 | Capture `tcpdump -i any host 10.234.241.21 and sctp port 2905` during flap — classify class 2/3/4 PDU direction. |
